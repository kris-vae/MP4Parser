...
SampleSizeBox::SampleSizeBox(uint32_t size, uint32_t type, uint64_t start_pos) : FullBox(size, type, start_pos) {}

SampleSizeBox::~SampleSizeBox() {

}

void SampleSizeBox::Parse(struct Parser *parser, uint64_t start_pos) {
