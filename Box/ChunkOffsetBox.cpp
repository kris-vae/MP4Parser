...
ChunkOffsetBox::ChunkOffsetBox(uint32_t size, uint32_t type, uint64_t start_pos) : FullBox(size, type, start_pos) {}

ChunkOffsetBox::~ChunkOffsetBox() {

}

void ChunkOffsetBox::Parse(struct Parser *parser, uint64_t start_pos) {
