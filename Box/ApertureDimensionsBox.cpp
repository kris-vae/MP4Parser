...
ApertureDimensionsBox::ApertureDimensionsBox(uint32_t size, uint32_t type, uint32_t start_pos)
...
void ApertureDimensionsBox::Parse(struct Parser *parser, uint32_t start_pos) {
